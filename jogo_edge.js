...
pontos=10;dif=3000;sym.$("gameover").hide();sym.$("pontosTxt").html(pontos);sym.$("lixo").draggable({start:function(event,ui){sym.$("lixo").stop(true);},stop:function(event,ui){sym.$("lixo").stop(true);sym.$("lixo").animate({left:96,top:127},250,function(){dif*=0.9;sym.dropLixo()});}});sym.dropLixo=function(){sym.$("lixo").animate({top:432},dif,function(){dif=Math.max(dif*0.9,100);pontos--
sym.getSymbol("lixo").stop(getRandomInt(0,3)*1000);sym.$('lixo').css({'left':96,'top':127});sym.$("pontosTxt").html(pontos);if(pontos==0){alert('Gamo Over');sym.$("gameover").show();sym.$("gameover2")[0].play();sym.$('lixo').draggable("destroy");}else{sym.$("error")[0].play();sym.dropLixo()}});}
...
sym.getSymbol("lixo").stop(getRandomInt(0,3)*1000);$(ui.draggable).css('left',96);$(ui.draggable).css('top',127);$(ui.draggable).fadeIn();sym.$("pontosTxt").html(pontos);if(pontos==0){alert('Gamo Over')
